...
// const jsonData = fs.readFileSync('./url.json').toString();
// const raml = raml2json.js2dt(jsonData, 'demo');
...
// const option = {
//   uri: 'http://172.20.60.48:8004/api/v1/roles',
//   headers: {
  ...
  for (let index = 0; index < obj.length; index++) {
    ...
    if (divider != undefined) {
      ...
      if (!fs.existsSync(dir + folder)) {
        ...
        requestFunction(option, dir, folder);
        // fs.writeFileSync(dir + folder + '/' + folder + '-item-delete.json', '');
        // fs.writeFileSync(dir + folder + '/' + folder + '-item-get.json', '');
        // fs.writeFileSync(
        //   dir + folder + '/' + folder + '-item-put-input.json',
        //   ''
        // );
        // fs.writeFileSync(
        //   dir + folder + '/' + folder + '-item-put-output.json',
        //   ''
        // );
        // fs.writeFileSync(
        //   dir + folder + '/' + folder + '-item-post-input.json',
        //   ''
        // );
        // fs.writeFileSync(
        //   dir + folder + '/' + folder + '-item-post-output.json',
        //   ''
        // );
...
const requestFunction = (option, dir, folder) => {
  request(option, (error, response, body) => {
    if (!error && response.statusCode == 200) {
      fs.writeFileSync(dir + folder + '/' + folder + '-get.json', body);
