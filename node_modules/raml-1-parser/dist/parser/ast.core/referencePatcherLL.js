            ...
            if (oldNS && oldNS.length > 0) {
                ...
                if (chainedUnit != null) {
                    ...
                    if (usesInfo_1 != null) {
                        ...
                        return new referencePatcherHL.PatchedReference(newNS_1, plainName, collectionName, chainedUnit, true, this.mode);
                    }
                }
            }
            return null;
    ...
    ReferencePatcher.prototype.patchDependencies = function (api, excessive) {
        ...
        for (var _i = 0, _a = api.children(); _i < _a.length; _i++) {
            ...
            var _loop_1 = function () {
                ...
                this_1.process(chNode, api, typeName, true, true);
                result = true;
            };
